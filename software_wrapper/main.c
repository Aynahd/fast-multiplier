...
#include <stdbool.h>
#include <stdio.h>
#include "xgpio.h"  // general purpise io
#include "xil_io.h"  // reading or writing memory mapped hardware
#include "xparameters.h"  // this is autogenerated.
// auto generated by xilinx hardware tools
// during the platform creation, board suppot package 
// contains IP base addresses, interrupt IDs and constants 
#include <string.h>
#include "matrix.h"
...
int main(void){
	...
	char matmul_str[50];
	char full_str[50];
	// strings to store formatted output ?
