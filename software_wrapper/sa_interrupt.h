#include "xscugic.h"	// xilinx generic interrupt controller
#include "xparameters.h" // autogenerated file 
#include <stdbool.h>   


// change this to the interrupt number 
#define XPAR_FABRIC_EXT_IRQ_INTR 61U
// trigger type of the interrput, no need to change 
